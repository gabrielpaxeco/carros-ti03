    ...
    items-center ">
      <section className="lg:flex max-w-[920px]">
        <div className="bg-orange p-12 max-lg:rounded-t-lg lg:rounded-l-lg">
          ...
          <a className="font-lexend bg-white px-10 py-3 block w-fit rounded-3xl text-orange border-2 border-offwhitebg hover:bg-orange hover:text-offwhitebg" href="https://www.webmotors.com.br/catalogo/carroceria/sedan/" target="_blank">Ver mais</a>
        </div>
        ...
        <div className="bg-dark-green p-12 max-lg:rounded-b-lg lg:rounded-r-lg">
          ...
          <a className="font-lexend mb-7 bg-white px-10 py-3 block w-fit rounded-3xl text-dark-green border-2 border-offwhitebg hover:bg-dark-green hover:text-offwhitebg" href="https://www.webmotors.com.br/carros-de-luxo" target="_blank">Ver mais</a>
        </div>
