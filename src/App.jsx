    ...
    <main className="py-20 px-6 min-h-svh bg-offwhitebg">
      <section>
        ...
        <div className="bg-green p-12">
          ...
          <a className="font-lexend" href="https://www.webmotors.com.br/catalogo/carroceria/suv/" target="_blank">Ver mais</a>
        </div>
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <a className="font-lexend mb-7" href="https://www.webmotors.com.br/carros-de-luxo" target="_blank">Ver mais</a>
        </div>
