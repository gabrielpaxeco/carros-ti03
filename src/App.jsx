    ...
    <main className="py-20 px-6 min-h-svh bg-offwhitebg">
      <section>
        <div className="bg-orange p-12 rounded-t-lg ">
          ...
          <a className="font-lexend bg-white px-10 py-3 block w-fit rounded-3xl text-orange" href="https://www.webmotors.com.br/catalogo/carroceria/sedan/" target="_blank">Ver mais</a>
        </div>
        <div className="bg-green p-12">
          ...
          <a className="font-lexend bg-white px-10 py-3 block w-fit rounded-3xl text-green" href="https://www.webmotors.com.br/catalogo/carroceria/suv/" target="_blank">Ver mais</a>
        </div>
        <div className="bg-dark-green p-12 rounded-b-lg">
          <img src={iconLuxo} alt="icone dos carros de luxo" className="mb-7" />
          ...
          <a className="font-lexend mb-7 bg-white px-10 py-3 block w-fit rounded-3xl text-dark-green" href="https://www.webmotors.com.br/carros-de-luxo" target="_blank">Ver mais</a>
        </div>
